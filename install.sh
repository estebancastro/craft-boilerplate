...
PATCHES_DIR="craft-boilerplate/patches"
...
ddev exec npm install --save-dev vite @vitejs/plugin-legacy tailwindcss @tailwindcss/vite rimraf rollup-plugin-critical vite-plugin-compression vite-plugin-live-reload vite-plugin-favicon2 regenerator-runtime terser @types/node
